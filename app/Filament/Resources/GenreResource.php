...
class GenreResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Ciudades/Géneros';
    protected static ?string $modelLabel = 'Ciudad/Género';
    protected static ?string $pluralModelLabel = 'Ciudades/Géneros';
