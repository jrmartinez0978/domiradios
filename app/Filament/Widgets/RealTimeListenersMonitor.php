...
class RealTimeListenersMonitor extends Widget
{
    ...
    protected static ?int $sort = 5; // Colocar encima, orden más bajo
    ...
    protected function parseListenersCount($sourceRadio, $data, $radioId)
    {
        ...
        switch ($sourceRadio) {
            case 'sonicpanel':
                ...
                $listeners = isset($json['listeners']) ? (int) $json['listeners'] : $this->getFictitiousListeners($radioId);
                break;
            ...
            case 'azuracast':
                ...
                $listeners = isset($json['listeners']['current']) ? (int) $json['listeners']['current'] : $this->getFictitiousListeners($radioId);
                break;
