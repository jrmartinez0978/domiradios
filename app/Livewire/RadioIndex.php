...
class RadioIndex extends Component
{
    ...
    public function mount()
    {
        ...
        $this->setSeoData(
            'Emisoras Dominicanas Online - Domiradios', // Título de la página
            ...
            asset('img/domiradios-logo-og.png') // Opcional: URL de una imagen para OpenGraph/Twitter. Asegúrate de que esta imagen exista.
        );
    }
