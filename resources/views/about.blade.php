...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-12">
    ...
    <div class="text-center mb-12">
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4">
            <span class="text-primary">Sobre Domiradios</span>
        </h1>
    ...
    <section class="card p-8 mb-8">
        ...
        <div class="text-gray-600 leading-relaxed space-y-4">
            <p>
                <strong class="text-gray-800">Domiradios</strong> nació con la misión de facilitar el acceso a la radio dominicana para todos.
    ...
    <section class="card p-8 mb-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <i class="fas fa-headphones text-primary mr-3"></i>
            Lo Que Hacemos
        </h2>
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-surface-100 rounded-xl p-5 border border-surface-300">
                <h3 class="font-bold text-gray-800 mb-2"><i class="fas fa-broadcast-tower text-primary mr-2"></i>Directorio de Emisoras</h3>
                <p class="text-gray-600 text-sm">Mantenemos un catálogo actualizado de más de 30 emisoras dominicanas con información detallada de cada una.</p>
            </div>
            <div class="bg-surface-100 rounded-xl p-5 border border-surface-300">
            ...
            <div class="bg-surface-100 rounded-xl p-5 border border-surface-300">
                ...
                <p class="text-gray-600 text-sm">Funciona en cualquier dispositivo: celulares, tablets, computadoras. Sin necesidad de instalar aplicaciones.</p>
            </div>
            <div class="bg-surface-100 rounded-xl p-5 border border-surface-300">
                <h3 class="font-bold text-gray-800 mb-2"><i class="fas fa-globe-americas text-primary mr-2"></i>Acceso Global</h3>
                <p class="text-gray-600 text-sm">Disponible en todo el mundo para los millones de dominicanos en el exterior que quieren mantener su conexión con la isla.</p>
            </div>
        </div>
    </section>
    ...
    <section class="card p-8 mb-8">
        ...
        <div class="text-gray-600 leading-relaxed space-y-4">
            ...
            <p>
                ...
                Puedes leer nuestra <a href="{{ route('privacidad') }}" class="text-primary hover:underline">Política de Privacidad</a>
                y nuestros <a href="{{ route('terminos') }}" class="text-primary hover:underline">Términos y Condiciones</a> para más detalles.
            </p>
        </div>
    </section>
    ...
    <div class="text-center">
        <p class="text-gray-500 mb-4">¿Tienes una emisora que quieres agregar al directorio?</p>
