...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="@yield('meta_description', 'Escucha emisoras de radio dominicanas en vivo. El directorio más completo de radios online en República Dominicana. Música, noticias y deportes en streaming.')" />
    ...
    <meta name="canonical" content="@yield('canonical_url', url()->current())">

    <!-- Open Graph / Facebook -->
    <meta property="og:site_name" content="Domiradios">
    <meta property="og:locale" content="es_DO">
    <meta property="og:title" content="@yield('og_title', 'Domiradios - Directorio de Emisoras de Radio Dominicanas en Vivo')" />
    <meta property="og:description" content="@yield('og_description', 'Escucha emisoras de radio dominicanas en vivo. El directorio más completo de radios online en República Dominicana.')" />
    ...
    <meta name="twitter:title" content="@yield('twitter_title', 'Domiradios - Emisoras Dominicanas en Vivo')" />
    <meta name="twitter:description" content="@yield('twitter_description', 'Escucha las mejores emisoras de radio dominicanas en streaming. Música, noticias y deportes.')" />
