    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <nav class="mb-6 text-sm">
            <ol class="flex items-center space-x-2 text-dark-400">
                ...
                <li>/</li>
                <li class="text-gray-100 font-semibold">Buscar</li>
            </ol>
        </nav>
        ...
        <div class="mb-12">
            ...
            <p class="text-xl text-dark-400 mb-6">
            ...
            <form action="{{ route('blog.search') }}" method="GET" class="max-w-2xl">
                <div class="relative">
                    <input
                        ...
                        class="w-full px-6 py-4 text-lg border-2 border-glass-border rounded-lg bg-glass-white-10 focus:ring-2 focus:ring-accent-red focus:border-transparent"
                        required
                    >
                    <button type="submit" class="absolute right-3 top-1/2 transform -translate-y-1/2 px-6 py-2 bg-accent-red text-white rounded-lg hover:bg-red-600 transition-colors">
                        Buscar
                    </button>
                </div>
            </form>
            ...
            <div class="md:col-span-2">
                ...
                @else
                    <div class="glass-card rounded-xl p-8 text-center">
                        ...
                        <p class="text-dark-400 text-lg mb-2">No se encontraron resultados para "{{ $query }}"</p>
                        <p class="text-dark-400 mb-6">Intenta con otras palabras clave o navega por categorías</p>
                        <a href="{{ route('blog.index') }}" class="inline-block text-accent-red hover:text-red-600 font-semibold">
