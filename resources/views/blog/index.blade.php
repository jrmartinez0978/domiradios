    ...
    <div class="container max-w-7xl mx-auto px-4 py-8">
        ...
        @if($featuredPosts->count() > 0)
            <section class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6 flex items-center">
                    <svg class="w-8 h-8 mr-3 text-brand-red" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-2">
                <h2 class="text-2xl font-bold text-gray-900 mb-6">Últimos Artículos</h2>
                ...
                @else
                    <div class="bg-white rounded-xl shadow-md p-8 text-center">
                        <p class="text-gray-600 text-lg">No hay posts publicados aún.</p>
                    </div>
                @endif
            </div>
                    ...
                    <form action="{{ route('blog.search') }}" method="GET">
                        <div class="relative">
                            <input
                                ...
                                required
                            >
                            <button type="submit" class="absolute right-2 top-2 text-brand-blue hover:text-brand-red">
