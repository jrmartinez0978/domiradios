...
@section('page-header')
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-100">Nueva Emisora</h2>
            <p class="text-dark-300 text-sm mt-1">Crear una nueva estacion de radio</p>
        </div>
    </div>
@endsection
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="glass-card p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <x-admin.form-select name="source_radio" label="Fuente" :options="['HTML5' => 'HTML5', 'RTCStream' => 'RTCStream']" required />
