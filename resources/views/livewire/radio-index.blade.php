...

{
    ...
    function togglePlay(id) {
        ...
        if (currentPlaying && currentPlaying !== player) {
            ...
            currentPlaying.nextElementSibling.textContent = 'Reproducir'; // Cambia el botón de la emisora anterior
        ...
        if (!player.paused) {
            ...
            intentos[id] = 0;
            // Intenta reproducir con reconexión
            intentarReproducir(player, playBtn, id);
        }
    }

    function intentarReproducir(player, playBtn, id) {
        const maxIntentos = 4;
        const retrasoIntento = 5000; // 5 segundos
        ...
        if (playPromise !== undefined) {
            playPromise.then(() => {
                ...
                if (intentos[id] < maxIntentos) {
                    ...
                    playBtn.classList.remove('bg-green-700', 'bg-red-700');
